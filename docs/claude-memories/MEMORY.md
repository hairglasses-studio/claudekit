...
- [user_profile.md](user_profile.md) — User's role, tools, preferences, and expertise
- [project_claudekit_vision.md](project_claudekit_vision.md) — Claudekit project vision, architecture decisions, and relationship to mcpkit
