...
**How to apply:** All code should follow mcpkit's architectural patterns (module-based, middleware chains, typed handlers, layered deps). Deliver as CLI + MCP server + Claude Code skill triple. Keep private repo for now but design for eventual open source distinction.
